...
PM_START_TEXT = """
<b>Hellow {message.from_user.first_name}.(https://telegra.ph/file/07c8c1fab879bb4fac148.jpg).```I am Geethu. A Telegram Group managment bot Created for Managing your group With Easy Modules```[😉].**Created under** @Cat_Telegram_Project_Club./help **Hit that button to see my Ability's**.Join @Cat_Telegram_Project_Club For support..Created with Love[❤] by @Cat_of_TelegramX"""
buttons = [
    [
        InlineKeyboardButton(
            text="➕️**Add Me**", url="t.me/Geethu_pro_bot?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
Hi i am [Geethu🙋‍♀️](https://telegra.ph/file/07c8c1fab879bb4fac148.jpg) 
Here is the help strings Available now...join @Cat_Telegram_Project_Club for updates"""

yone_IMG = "https://telegra.ph/file/07c8c1fab879bb4fac148.jpg"
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Geethu*
                 \nHere is the [Source Code](https://t.me/Cat_Telegram_Project_Club) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
